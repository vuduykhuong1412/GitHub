...
<div class="box">
    ...
    <div class="row addresses-lists">
        <div class="col-xs-12 col-sm-6 col-lg-6">
            <ul class="list-unstyled myaccount-link-list ">
    ...
    <li><a class="btn btn-default" href="{$base_dir}" title="{l s='Home'}"><span><i class="icon-chevron-left left"></i> {l s='Home'}</span></a></li>
    </ul>
</div>