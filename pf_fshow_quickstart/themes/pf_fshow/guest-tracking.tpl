...
{if isset($order_collection)}
	{foreach $order_collection as $order}
		...
		<div id="block-history">
			<div id="block-order-detail" class="std form-horizontal">
	...
	{else}
		<form method="post" action="{$action|escape:'html':'UTF-8'}#guestToCustomer" class="std form-horizontal">
...
{else}
	...
	{/if}
	<form method="post" action="{$action|escape:'html':'UTF-8'}" class="std form-horizontal" id="guestTracking">
		<fieldset class="description_box box">
