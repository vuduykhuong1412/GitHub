...
CREATE TABLE `PREFIX_pagebuilderprofile` (
  `name` varchar(255) NOT NULL,
...
CREATE TABLE `PREFIX_pagebuilderprofile_shop` (
...
CREATE TABLE `PREFIX_psmegamenu` (
...
CREATE TABLE `PREFIX_psmegamenu_lang` (
...
CREATE TABLE `PREFIX_psmegamenu_shop` (
  `id_psmegamenu` int(11) NOT NULL DEFAULT '0',
  `id_shop` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_psmegamenu`,`id_shop`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `PREFIX_psmegamenu_widgets` (
...
CREATE TABLE `PREFIX_pssliderlayer_groups` (
  `id_pssliderlayer_groups` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `id_shop` int(10) unsigned NOT NULL,
  `hook` varchar(64) NOT NULL,
  `active` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `params` text NOT NULL,
  PRIMARY KEY (`id_pssliderlayer_groups`,`id_shop`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

CREATE TABLE `PREFIX_pssliderlayer_slides` (
  `id_pssliderlayer_slides` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_group` int(11) NOT NULL,
  `position` int(10) unsigned NOT NULL DEFAULT '0',
  `active` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `params` text NOT NULL,
  PRIMARY KEY (`id_pssliderlayer_slides`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8;

CREATE TABLE `PREFIX_pssliderlayer_slides_lang` (
  `id_pssliderlayer_slides` int(10) unsigned NOT NULL,
  `id_lang` int(10) unsigned NOT NULL,
  `title` varchar(255) NOT NULL,
  `link` varchar(255) NOT NULL,
  `image` varchar(255) NOT NULL,
  ...
  `video` text,
  `layersparams` text,
  PRIMARY KEY (`id_pssliderlayer_slides`,`id_lang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `PREFIX_psverticalmenu` (
...
CREATE TABLE `PREFIX_psverticalmenu_lang` (
...
CREATE TABLE `PREFIX_psverticalmenu_shop` (
  `id_psverticalmenu` int(11) NOT NULL DEFAULT '0',
  `id_shop` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_psverticalmenu`,`id_shop`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `PREFIX_psverticalmenu_widgets` (
  `id_widget` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
  `type` varchar(255) NOT NULL,
  `params` text NOT NULL,
...
CREATE TABLE `PREFIX_ptsbttestimonials` (
...
CREATE TABLE `PREFIX_ptsbttestimonials_lang` (
...
CREATE TABLE `PREFIX_ptsbttestimonials_shop` (
  `id_ptsbttestimonials` int(10) unsigned NOT NULL,
  `id_shop` int(10) NOT NULL,
  PRIMARY KEY (`id_ptsbttestimonials`,`id_shop`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `PREFIX_ptsmegamenu` (
...
CREATE TABLE `PREFIX_ptsmegamenu_lang` (
...
CREATE TABLE `PREFIX_ptsmegamenu_shop` (
  `id_ptsmegamenu` int(11) NOT NULL DEFAULT '0',
  `id_shop` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_ptsmegamenu`,`id_shop`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `PREFIX_ptsmegamenu_widgets` (
  `id_widget` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
  `type` varchar(255) NOT NULL,
  `params` text NOT NULL,
...
CREATE TABLE `PREFIX_ptsverticalmenu` (
...
CREATE TABLE `PREFIX_ptsverticalmenu_lang` (
...
CREATE TABLE `PREFIX_ptsverticalmenu_shop` (
  `id_ptsverticalmenu` int(11) NOT NULL DEFAULT '0',
  `id_shop` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_ptsverticalmenu`,`id_shop`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `PREFIX_ptsverticalmenu_widgets` (
  `id_widget` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
  `type` varchar(255) NOT NULL,
  `params` text NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=20962 DEFAULT CHARSET=utf8;
