...
<div class="addresses clearfix">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6"{if $cart->isVirtualCart()} style="display:none;"{/if}>
			<ul class="list-unstyled address item box" id="address_delivery">
			</ul>
		</div>
		<div class="col-xs-12 col-sm-6">
...
{if !$opc}
			<p class="cart_navigation clearfix">
				...
				<button type="submit" name="processAddress" class="button btn btn-default button-medium pull-right">
