	...
	<div class="container">
		<div class="breadcrumbs space-padding-tb-10  breadcrumbs-left">    
	    	<div class="inner">
				...
				<div class="sub-navigation">
					<span class="navigation_page">{$path|@replace:'<a ': '<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
						<a itemprop="url" '|@replace:'data-gg="">': '><span itemprop="title">'|@replace:'</a>': '</span></a>
					</span>'}</span>
				</div>
			</div>
		</div>
		...
		<div class="pull-right">
			<strong>
				...
				<a class="btn" href="{$smarty.capture.default|escape:'html':'UTF-8'|secureReferrer|regex_replace:'/[\?|&]content_only=1/':''}" name="back">
