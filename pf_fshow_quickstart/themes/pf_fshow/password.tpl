...
<div class="box">
	...
	{else}
		...
		<form action="{$request_uri|escape:'html':'UTF-8'}" method="post" class="std form-horizontal" id="form_forgotpassword">
			<fieldset>
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-4 col-md-4 col-lg-4" for="email">{l s='Email address'}</label>
	...
	<ul class="clearfix footer_links list-unstyled">
		<li><a class="btn-default button btn" href="{$link->getPageLink('authentication')|escape:'html':'UTF-8'}" title="{l s='Back to Login'}" rel="nofollow"><span><i class="icon-chevron-left left"></i>{l s='Back to Login'}</span></a></li>
	</ul>
</div>