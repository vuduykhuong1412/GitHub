...
<ul class="list-unstyled display hidden-xs">
	<li>{l s='View'}</li>
    <li id="grid"><a data-toggle="tooltip" rel="nofollow" href="#" title="{l s='Grid'}"><i class="icon-th-large"></i><span>{l s='Grid'}</span></a></li>
    <li id="list"><a data-toggle="tooltip" rel="nofollow" href="#" title="{l s='List'}"><i class="icon-th-list"></i><span>{l s='List'}</span></a></li>
</ul>
...
<form id="productsSortForm{if isset($paginationId)}_{$paginationId}{/if}" action="{$request|escape:'html':'UTF-8'}" class="productsSortForm">
	<div class="select selector2">
		<!-- <span for="selectProductSort{if isset($paginationId)}_{$paginationId}{/if}">{l s='Sort by'}</span> -->
