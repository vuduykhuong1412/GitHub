...
<div class="product-block {if Configuration::get('PTS_CP_PRODUCT_LAYOUT') == 'gallery' && ($hook != left) && ($hook != right) }swap-gallery{/if}" itemscope itemtype="http://schema.org/Product">
