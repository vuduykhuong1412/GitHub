...
<div id="mywishlist">
	...
	{if $id_customer|intval neq 0}
		<form method="post" class="std box form-horizontal" id="form_wishlist">
			<fieldset>
	...
	<ul class="footer_links clearfix">
		<li class="pull-left">
			<a class="btn btn-default button button-small" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
				<span>
					<i class="icon-chevron-left left"></i>{l s='Back to Your Account' mod='blockwishlist'}
				</span>
			</a>
		</li>
		<li class="pull-right">
			<a class="btn btn-default button button-small" href="{$base_dir|escape:'html':'UTF-8'}">
				<span>
					<i class="icon-chevron-left left"></i>{l s='Home' mod='blockwishlist'}
				</span>
			</a>
		</li>
	</ul>
