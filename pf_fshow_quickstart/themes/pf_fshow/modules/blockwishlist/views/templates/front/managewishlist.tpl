...
{if $products}
    {if !$refresh}
        ...
        <a id="hideWishlist" class="button_account icon"  href="#" onclick="WishlistVisibility('wishlistLinkTop', 'SendWishlist'); return false;" rel="nofollow" title="{l s='Close this wishlist' mod='blockwishlist'}">
            <i class="icon-remove"></i>
        </a>
        <ul class="list-unstyled clearfix display_list">
            <li>
    ...
    <div class="wlp_bought">
        ...
        <ul class="list-unstyled row wlp_bought_list">
