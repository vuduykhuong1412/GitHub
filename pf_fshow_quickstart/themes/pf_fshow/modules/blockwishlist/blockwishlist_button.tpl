...
<div class="wishlist">
	{foreach name=wl from=$wishlists item=wishlist}
		...
		{/if}
	{foreachelse}
		<a class="btn addToWishlist wishlistProd_{$product.id_product|intval}" title="{l s='Add to Wishlist' mod='blockwishlist'}" data-toggle="tooltip" href="#" onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|intval}', false, 1); return false;">
