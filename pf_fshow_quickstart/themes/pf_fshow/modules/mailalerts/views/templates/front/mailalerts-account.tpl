...
<div id="mailalerts_block_account" class="block">
	...
	{if $mailAlerts}
		<ul class="list-unstyled products-block">
	...
	<ul class="footer_links clearfix">
		<li><a class="btn btn-default button button-small" href="{$link->getPageLink('my-account', true)|escape:'html'}" title="{l s='Back to Your Account' mod='mailalerts'}"><span><i class="icon-chevron-left left"></i>{l s='Back to Your Account' mod='mailalerts'}</span></a></li>
	</ul>
</div>
