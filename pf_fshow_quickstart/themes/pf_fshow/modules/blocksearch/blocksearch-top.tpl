...
<div class="block-search">
	<div class="btn-group search-focus">
		<div class="dropdown-toggle btn-theme-normal">
			<span class="text-label title hidden">{l s='SEARCH' mod='blocksearch'}</span>
		</div>
	</div>
	<div style="" id="search_block_top" class="inner nav-search visible">
		<form id="searchbox" method="get" action="{$link->getPageLink('search', null, null, null, false, null, true)|escape:'html':'UTF-8'}" >
			<div class="input-group">
				...
				<input id="search_query_top" class="search-control search_query form-control ac_input" type="text" placeholder="{l s='Enter keyword here...' mod='blocksearch'}" name="search_query" value="{$search_query|escape:'htmlall':'UTF-8'|stripslashes}"  />
