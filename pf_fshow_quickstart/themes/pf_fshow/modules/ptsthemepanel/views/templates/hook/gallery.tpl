{if $ptsimages}
	<div class="thumbs-wrap">
		...
		<a id="view_scroll_left{$ptsgkey}" class="view_scroll_left {if isset($ptsimages) && count($ptsimages) < 4}hidden{/if}" href="javascript:{}" title="Other views"><i class="icon-chevron-up"></i></a>
		...
		<a id="view_scroll_right{$ptsgkey}" class="view_scroll_right {if isset($ptsimages) && count($ptsimages) < 4}hidden{/if}" href="javascript:{}" title="Other views"><i class="icon-chevron-down"></i></a>
	</div>
