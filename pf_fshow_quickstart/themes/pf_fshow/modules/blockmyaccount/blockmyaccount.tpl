...
<div class="block myaccount-column block-borderbox">
	...
	<div class="block_content box-content">
		...
		<div class="logout">
			<a class="btn-links button btn" href="{$link->getPageLink('index', true, NULL, "mylogout")|escape:'html':'UTF-8'}" title="{l s='Sign out' mod='blockmyaccount'}">
