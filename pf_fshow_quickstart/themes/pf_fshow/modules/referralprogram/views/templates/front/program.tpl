...
<div class="sheets tab-content">
	...
	<div id="idTab1" class="tab-pane active">
		...
		{if $canSendInvitations}
			...
			<form method="post" action="{$link->getModuleLink('referralprogram', 'program', [], true)|escape:'html':'UTF-8'}" class="std form-horizontal">
...
<ul class="footer_links clearfix">
	<li class="pull-left">
		...
		<span><i class="icon-chevron-left left"></i> {l s='Back to Your Account' mod='referralprogram'}</span></a>
	</li>
	<li class="pull-right"><a class="btn btn-default button button-small" href="{$base_dir}" title="{l s='Home' mod='referralprogram'}"><span><i class="icon-chevron-left left"></i>{l s='Home' mod='referralprogram'}</span></a></li>
</ul>
