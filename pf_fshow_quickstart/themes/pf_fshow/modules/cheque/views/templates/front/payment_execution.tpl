...
{else}
	...
	<form action="{$link->getModuleLink('cheque', 'validation', [], true)|escape:'html':'UTF-8'}" method="post">
		...
		<p class="cart_navigation clearfix" id="cart_navigation">
			<a href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html':'UTF-8'}" class="button-exclusive btn btn-default pull-left">
				<i class="icon-chevron-left left"></i>{l s='Other payment methods' mod='cheque'}
			</a>
