				...
				<div id="opc_account_form" style="display: block; ">
					...
					<div id="opc_invoice_address"  class="unvisible">
						...
						<div class="required postcode_invoice form-group">
							...
							<div class="col-sm-6">
				                		<input type="text" class="validate form-control" name="postcode_invoice" id="postcode_invoice" value="{if isset($smarty.post.postcode_invoice) && $smarty.post.postcode_invoice}{$smarty.post.postcode_invoice}{/if}" onkeyup="$('#postcode_invoice').val($('#postcode_invoice').val().toUpperCase());" />
							</div>
						</div>
						{elseif $field_name eq "city"}
						<div class="required form-group">
