<?php /* Smarty version Smarty-3.1.19, created on 2015-11-20 03:20:12
         compiled from "E:\Project\htdocs\pf_fshow_quickstart\modules\pspagebuilder\views\templates\admin\_configure\helpers\form\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9972564ed7bc998104-91155117%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a424adb26ca4cc77b7fe1ae0da6d7fb838571c4a' => 
    array (
      0 => 'E:\\Project\\htdocs\\pf_fshow_quickstart\\modules\\pspagebuilder\\views\\templates\\admin\\_configure\\helpers\\form\\form.tpl',
      1 => 1447226920,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '9972564ed7bc998104-91155117',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_564ed7bd3377e8_00067995',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_564ed7bd3377e8_00067995')) {function content_564ed7bd3377e8_00067995($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'E:\\Project\\htdocs\\pf_fshow_quickstart\\tools\\smarty\\plugins\\function.counter.php';
?>
...
?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='category_tab') {?>
        <div class="form-group">
            <div class="col-lg-9 col-lg-offset-3">
                <?php echo $_smarty_tpl->tpl_vars['input']->value['category_tpl'];?>

                <div style="clear:both;"></div>
                <div id="category_tab_image">
                    <?php if ($_smarty_tpl->tpl_vars['fields_value']->value['categorytab']) {?>
                        <?php  $_smarty_tpl->tpl_vars['val'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['val']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['fields_value']->value['categorytab']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['val']->key => $_smarty_tpl->tpl_vars['val']->value) {
$_smarty_tpl->tpl_vars['val']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['val']->key;
?>
                            <div id="categorytab_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
">
                                <label>Set icon for: <strong><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
</strong></label>
                                <div class="pts-container" style="padding:10px; border: 1px solid #e6e6e6;">
                                    <label>Icon Class</label>
                                    <input type="text" name="categorytab[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
][icon_class]" class="icon_class_category" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['val']->value['icon_class'], ENT_QUOTES, 'UTF-8', true);?>
">

                                    <label>Icon</label>
                                    <input type="text" name="categorytab[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
][icon]" class="icon_category" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['val']->value['icon'], ENT_QUOTES, 'UTF-8', true);?>
">
                                </div>
                                <br><br>
                            </div>
                            ...
                            <script type="text/javascript">
                                $('#categorytab_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
 .icon_category').WPO_Gallery();
                            </script>
                        <?php } ?>
                    <?php }?>
                </div>
    ...
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='promotions') {?>
        <div class="form-group">
            <div class="col-lg-9 col-lg-offset-3">
                <div style="clear:both;"></div>
                <div id="promotions_image_mng">
                    <?php if ($_smarty_tpl->tpl_vars['fields_value']->value['promotions']) {?>
                        <?php  $_smarty_tpl->tpl_vars['val'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['val']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['fields_value']->value['promotions']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['val']->key => $_smarty_tpl->tpl_vars['val']->value) {
$_smarty_tpl->tpl_vars['val']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['val']->key;
?>
                            <div id="promotions_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
" class="promotion_item">
                                <div class="pts-container" style="padding:10px; border: 1px solid #e6e6e6;">
                                    <label>Title</label>
                                    <input type="text" name="promotions[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
][title]" class="title_promotion" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['val']->value['title'], ENT_QUOTES, 'UTF-8', true);?>
">

                                    <label>Description</label>
                                    <textarea class="rte_promotion rte_promotion_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
" name="promotions[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
][description]">
                                    ...
                                    <label>Url</label>
                                    <input type="text" name="promotions[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
][url]" class="url_promotion" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['val']->value['url'], ENT_QUOTES, 'UTF-8', true);?>
">

                                    <label>Image</label>
                                    <input type="text" name="promotions[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
][image]" class="image_promotion" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['val']->value['image'], ENT_QUOTES, 'UTF-8', true);?>
">
                    ...
                    <?php } else { ?>
                        <div id="promotions_0" class="promotion_item">
                            <div class="pts-container" style="padding:10px; border: 1px solid #e6e6e6;">
                                ...
                                <label>Image</label>
                                <input type="text" name="promotions[0][image]" class="image_promotion" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['val']->value['image'], ENT_QUOTES, 'UTF-8', true);?>
">
                            </div>
                            <br><br>
                        </div>
    ...
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='products_slideshow') {?>
        <div class="form-group">
            <div class="col-lg-9 col-lg-offset-3">
                <div style="clear:both;"></div>
                <div id="pro_slide_image_mng">
                    <?php if ($_smarty_tpl->tpl_vars['fields_value']->value['products_slideshow']) {?>
                        <?php  $_smarty_tpl->tpl_vars['val'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['val']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['fields_value']->value['products_slideshow']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['val']->key => $_smarty_tpl->tpl_vars['val']->value) {
$_smarty_tpl->tpl_vars['val']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['val']->key;
?>
                            <div id="pro_slide_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
" class="pro_slide_item">
                                <div class="pts-container" style="padding:10px; border: 1px solid #e6e6e6;">
                                <div>
                                    <label>Background</label>
                                    <input type="text" name="products_slideshow[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
][background]" class="background_pro_slide" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['val']->value['background'], ENT_QUOTES, 'UTF-8', true);?>
">
                                </div>
                                <div>
                                    <label>Image</label>
                                    <input type="text" name="products_slideshow[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
][image]" class="image_pro_slide" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['val']->value['image'], ENT_QUOTES, 'UTF-8', true);?>
">
                                    </div>
                                    <label>Product Id</label>
                                    <input type="text" name="products_slideshow[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
][id_product]" class="product_pro_slide" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['val']->value['id_product'], ENT_QUOTES, 'UTF-8', true);?>
">
                    ...
                    <?php } else { ?>
                        <div id="pro_slide_0" class="promotion_item">
                            <div class="pts-container" style="padding:10px; border: 1px solid #e6e6e6;">
                                <div>
                                <label>Background</label>
                                <input type="text" name="products_slideshow[0][background]" class="background_pro_slide" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['val']->value['background'], ENT_QUOTES, 'UTF-8', true);?>
">
                                </div>
                                <div>
                                <label>Image</label>
                                <input type="text" name="products_slideshow[0][image]" class="image_pro_slide" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['val']->value['image'], ENT_QUOTES, 'UTF-8', true);?>
">
                                </div>
                                <label>Product Id</label>
                                <input type="text" name="products_slideshow[0][id_product]" class="product_pro_slide" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['val']->value['id_product'], ENT_QUOTES, 'UTF-8', true);?>
">
                            </div>
                            <br><br>
                        </div>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '9972564ed7bc998104-91155117');
content_564ed7bd0ce334_48698975($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2015-11-20 03:20:13
         compiled from "E:\Project\htdocs\pf_fshow_quickstart\admin123\themes\default\template\helpers\form\form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_564ed7bd0ce334_48698975')) {function content_564ed7bd0ce334_48698975($_smarty_tpl) {?>
