<?php /* Smarty version Smarty-3.1.19, created on 2015-11-22 23:36:58
         compiled from "E:\Project\htdocs\pf_fshow_quickstart\themes\pf_fshow\contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13412565297eaa9e8b7-59688165%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7ca71c0aa9d6972310d8831d2c3e6da6af59b632' => 
    array (
      0 => 'E:\\Project\\htdocs\\pf_fshow_quickstart\\themes\\pf_fshow\\contact-form.tpl',
      1 => 1447226940,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13412565297eaa9e8b7-59688165',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_565297eaca30c6_63781020',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_565297eaca30c6_63781020')) {function content_565297eaca30c6_63781020($_smarty_tpl) {?>
...
<?php if (isset($_smarty_tpl->tpl_vars['confirmation']->value)) {?>
	...
	<ul class="footer_links list-unstyled clearfix">
		<li>
            <a class="btn-default button btn" href="<?php echo $_smarty_tpl->tpl_vars['base_dir']->value;?>
">
                <span>
                    <i class="icon-chevron-left left"></i><?php echo smartyTranslate(array('s'=>'Home'),$_smarty_tpl);?>
...
" method="post" class="contact-form-box box" enctype="multipart/form-data">
		<fieldset>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['label'], ENT_QUOTES, 'UTF-8', true);?>
                                ...
                                <?php } elseif ($_smarty_tpl->tpl_vars['customerThread']->value['id_product']>0) {?>
                                    <input class="form-control" type="hidden" name="id_product" id="id_product" value="<?php echo intval($_smarty_tpl->tpl_vars['customerThread']->value['id_product']);?>
" readonly="readonly" />
                                <?php }?>
                            </div>
                        <?php }?>
