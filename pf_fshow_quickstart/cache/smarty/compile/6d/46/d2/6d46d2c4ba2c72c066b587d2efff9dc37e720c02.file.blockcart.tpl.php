<?php /* Smarty version Smarty-3.1.19, created on 2015-12-06 22:15:35
         compiled from "E:\Xampp\htdocs\pf_fshow_quickstart\themes\pf_fshow\modules\blockcart\blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:247905664f9d7d4eb60-95088295%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d46d2c4ba2c72c066b587d2efff9dc37e720c02' => 
    array (
      0 => 'E:\\Xampp\\htdocs\\pf_fshow_quickstart\\themes\\pf_fshow\\modules\\blockcart\\blockcart.tpl',
      1 => 1448352283,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '247905664f9d7d4eb60-95088295',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5664f9d8168989_77116297',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5664f9d8168989_77116297')) {function content_5664f9d8168989_77116297($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'E:\\Xampp\\htdocs\\pf_fshow_quickstart\\tools\\smarty\\plugins\\modifier.replace.php';
...
<div id="pts-mini-cart" class=" clearfix<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> header_user_catalog<?php }?>">
<?php }?>
...
" rel="nofollow">
					<span class="cart-title"><?php echo smartyTranslate(array('s'=>'My cart','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
					<span class="ajax_cart_quantity mini-cart-count"><?php echo $_smarty_tpl->tpl_vars['cart_qties']->value;?>
</span>
					...
					<span class="ajax_cart_product_txt_s hidden<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value<2) {?> unvisible<?php }?>"><?php echo smartyTranslate(array('s'=>'items','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
					<!--<?php echo smartyTranslate(array('s'=>'( ','mod'=>'blockcart'),$_smarty_tpl);?>
 -->
						<span class="ajax_cart_total hidden <?php if ($_smarty_tpl->tpl_vars['cart_qties']->value==0) {?> unvisible<?php }?>">
						...
						<span class="ajax_cart_no_product hidden<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value>0) {?> unvisible<?php }?>">
							<span class="mini-cart-count"><?php echo smartyTranslate(array('s'=>'0','mod'=>'blockcart'),$_smarty_tpl);?>
 <!--<?php echo smartyTranslate(array('s'=>'item','mod'=>'blockcart'),$_smarty_tpl);?>
--></span><span class="hidden"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>0),$_smarty_tpl);?>
</span>
						</span>
					<!--<?php echo smartyTranslate(array('s'=>' )','mod'=>'blockcart'),$_smarty_tpl);?>
 -->
...
<?php $_tmp7=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&id_product=".$_tmp5."&ipa=".$_tmp6."&id_address_delivery=".$_tmp7."&token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php } else { ?>0<?php }?>" class="<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['first']) {?>first_item<?php } elseif ($_smarty_tpl->getVariable('smarty')->value['foreach']['myLoop']['last']) {?>last_item<?php } else { ?>item<?php }?>">
											<?php }?>
											<ul class="list-unstyled cart_block_customizations" data-id="customization_<?php echo $_smarty_tpl->tpl_vars['productId']->value;?>
...
<?php $_tmp9=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['id_customization']->value);?>
<?php $_tmp10=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&id_product=".$_tmp8."&ipa=".$_tmp9."&id_customization=".$_tmp10."&token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)), ENT_QUOTES, 'UTF-8', true);?>
" rel="nofollow">&nbsp;</a>
														</div>
						...
						<?php if (count($_smarty_tpl->tpl_vars['discounts']->value)>0) {?>
							<table class="vouchers mini-cart-vouchers<?php if (count($_smarty_tpl->tpl_vars['discounts']->value)==0) {?> unvisible<?php }?>">
...
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['cart']->value->getOrderTotal(true,$_smarty_tpl->tpl_vars['cart_flag']->value)),$_smarty_tpl);?>
							...
							<p class="cart-buttons clearfix">
								<a id="button_order_cart" class="btn button button-small pull-right" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
...
<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&$_smarty_tpl->tpl_vars['active_overlay']->value==1) {?>
	<div id="layer_cart">
			<div class="contain-cart clearfix">
					<div class="row bg-white">
						<div class="layer_cart_product col-xs-12 col-md-6 bg-white">
...
"></span>
						...
						<div class="layer_cart_cart col-xs-12 col-md-6 bg-white">
							<h2>
...
">
								...
								<a class="btn btn-default button button-medium pull-right"	href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
