<?php /* Smarty version Smarty-3.1.19, created on 2015-11-23 05:10:08
         compiled from "E:\Project\htdocs\pf_fshow_quickstart\modules\pssliderlayer\views\templates\admin\_configure\helpers\form\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:173915652e600d05ff0-26571624%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e17c98ad132edf2f3152d7cd2aa9cbeb6581e3e1' => 
    array (
      0 => 'E:\\Project\\htdocs\\pf_fshow_quickstart\\modules\\pssliderlayer\\views\\templates\\admin\\_configure\\helpers\\form\\form.tpl',
      1 => 1447226796,
      2 => 'file',
    ),
    '1a9c1bc021e6d417962b553aec60994cc2c2b263' => 
    array (
      0 => 'E:\\Project\\htdocs\\pf_fshow_quickstart\\admin123\\themes\\default\\template\\helpers\\form\\form.tpl',
      1 => 1447226168,
      2 => 'file',
    ),
    '0184abc26fddf49119385dd1d78fa9d4f6d7c7eb' => 
    array (
      0 => 'E:\\Project\\htdocs\\pf_fshow_quickstart\\admin123\\themes\\default\\template\\helpers\\form\\form_group.tpl',
      1 => 1447226168,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '173915652e600d05ff0-26571624',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5652e601da1b10_39342971',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5652e601da1b10_39342971')) {function content_5652e601da1b10_39342971($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'E:\\Project\\htdocs\\pf_fshow_quickstart\\tools\\smarty\\plugins\\function.counter.php';
if (!is_callable('smarty_modifier_replace')) include 'E:\\Project\\htdocs\\pf_fshow_quickstart\\tools\\smarty\\plugins\\modifier.replace.php';
?>
...
" <?php if ($_smarty_tpl->tpl_vars['language']->value['id_lang']!=$_smarty_tpl->tpl_vars['defaultFormLanguage']->value) {?>style="display:none"<?php }?>>
                    ...
                    <div class="col-lg-6">
                        <div class="upload-img-form">
                            <img id="thumb_slider_thumbnail_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" width="50" class="<?php if (!$_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']][$_smarty_tpl->tpl_vars['language']->value['id_lang']]) {?>nullimg<?php }?>" alt="" src="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['psBaseModuleUri']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']][$_smarty_tpl->tpl_vars['language']->value['id_lang']], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"/>
                            <input id="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" type="hidden" name="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" class="hide" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']][$_smarty_tpl->tpl_vars['language']->value['id_lang']], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
                            <br>
                            <a onclick="image_upload('<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
', 'thumb_slider_thumbnail_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
');" href="javascript::void(0);"><?php echo smartyTranslate(array('s'=>'Browse','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                            <a onclick="$('#thumb_slider_thumbnail_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
').attr('src', '');$('#thumb_slider_thumbnail_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
').addClass('nullimg'); $('#<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
').attr('value', '');" href="javascript::void(0);"><?php echo smartyTranslate(array('s'=>'Clear','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</a>
                        </div>
                        <br/>
                    </div>
...
?>
                ...
                <script>
                    $(document).ready(function() {
                        $('#<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
-name').val(file[file.length - 1]);
                ...
                <input id="slider-image_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" type="hidden" name="image_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" class="hide" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value["image"][$_smarty_tpl->tpl_vars['language']->value['id_lang']], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
            <?php } ?>
        </div>
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='group_background') {?>
        <div class="col-lg-9">
            <div class="upload-img-form">
               <img id="img_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['id'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" width="50" class="<?php ob_start();?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php $_tmp1=ob_get_clean();?><?php if (!$_tmp1) {?>nullimg<?php }?>" alt="<?php echo smartyTranslate(array('s'=>'Group Back-ground','mod'=>'pssliderlayer'),$_smarty_tpl);?>
" src="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['psBaseModuleUri']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"/>
               <input id="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['id'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" type="hidden" name="group[background_url]" class="hide" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" />
               <br>
               <a onclick="background_upload('<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['id'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
', 'img_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['id'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
','<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['ajaxfilelink']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
', '<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['psBaseModuleUri']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
');" href="javascript:void(0);"><?php echo smartyTranslate(array('s'=>'Browse','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</a>&nbsp;&nbsp;|&nbsp;&nbsp;
               <a onclick="$('#img_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['id'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
').attr('src', '');$('#img_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['id'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
').addClass('nullimg'); $('#<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['id'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
').attr('value', '');" href="javascript:void(0);"><?php echo smartyTranslate(array('s'=>'Clear','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</a>
           </div>
            <p><?php echo smartyTranslate(array('s'=>'Click to upload or select a back-ground','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</p>
        </div>
    <?php }?>
        ...
        <div class="form-group">
            <div class="col-lg-9 col-lg-offset-3">
                <div class="btn-group pull-right">
                    <a class="btn btn-default <?php if (count($_smarty_tpl->tpl_vars['languages']->value)>1) {?>dropdown-toggle <?php } else { ?>group-preview <?php }?>color_danger" href="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['previewLink']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&id_group=<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['id_group'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
?>
                        <li>
                            <?php $_smarty_tpl->tpl_vars['arrayParam'] = new Smarty_variable(array('secure_key'=>$_smarty_tpl->tpl_vars['msecure_key']->value,'id_group'=>$_smarty_tpl->tpl_vars['input']->value['id_group']), null, 0);?>
...
" class="group-preview">
 ...
 <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
                ...
                <button class="btn btn-default dash_trend_right" name="submitGroup" id="module_form_submit_btn" type="submit">
                        <i class="icon-save"></i> <?php echo smartyTranslate(array('s'=>'Save','mod'=>'pssliderlayer'),$_smarty_tpl);?>
...
&configure=pssliderlayer&showsliders=1&id_group=<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['id_group'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"><i class="icon-film"></i> <?php echo smartyTranslate(array('s'=>'Manages Sliders','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</a>
                <a class="btn btn-default" href="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['exportLink']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&id_group=<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['id_group'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"><i class="icon-eye-open"></i> <?php echo smartyTranslate(array('s'=>'Export Group and sliders','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</a>
                <a class="btn btn-default" href="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminModules'), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&configure=pssliderlayer&deletegroup=1&id_group=<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['id_group'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
" class="delete">
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='sperator_form') {?>
        <div class="<?php if (isset($_smarty_tpl->tpl_vars['input']->value['class'])) {?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['class'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php } else { ?>alert alert-info<?php }?>"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['text'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</div>
    <?php }?>
...
" <?php if ($_smarty_tpl->tpl_vars['language']->value['id_lang']!=$_smarty_tpl->tpl_vars['defaultFormLanguage']->value) {?>style="display:none"<?php }?>>
                    ...
                    <div class="col-lg-6">
                        <div class="radiolabel">
                            <lable><?php echo smartyTranslate(array('s'=>'Video Type','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</lable>
                            <select name="usevideo_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" class="">
                                <option <?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']])&&$_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]&&$_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]=="0") {?>selected="selected"<?php }?> value="0"><?php echo smartyTranslate(array('s'=>'No','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</option>
                                <option <?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']])&&$_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]&&$_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]=="youtube") {?>selected="selected"<?php }?> value="youtube"><?php echo smartyTranslate(array('s'=>'Youtube','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</option>
                                <option <?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']])&&$_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]&&$_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]=="vimeo") {?>selected="selected"<?php }?> value="vimeo"><?php echo smartyTranslate(array('s'=>'Vimeo','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</option>
                            </select>
                        </div>
                        <div class="radiolabel">
                            <lable><?php echo smartyTranslate(array('s'=>'Video ID','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</lable>
                            <input id="videoid_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" name="videoid_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" type="text" <?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value["videoid"][$_smarty_tpl->tpl_vars['language']->value['id_lang']])&&$_smarty_tpl->tpl_vars['fields_value']->value["videoid"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]) {?> value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value["videoid"][$_smarty_tpl->tpl_vars['language']->value['id_lang']], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"<?php }?>/>
                            <div class="input-group col-lg-2">
                            </div>
                            <div class="input-group col-lg-2">
                                <lable><?php echo smartyTranslate(array('s'=>'Auto Play','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</lable>
                                <select name="videoauto_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
">
                                    <option value="1" <?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value["videoauto"][$_smarty_tpl->tpl_vars['language']->value['id_lang']])&&$_smarty_tpl->tpl_vars['fields_value']->value["videoauto"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]==1) {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'Yes','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</option>
                                    <option value="0" <?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value["videoauto"][$_smarty_tpl->tpl_vars['language']->value['id_lang']])&&$_smarty_tpl->tpl_vars['fields_value']->value["videoauto"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]==0) {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'No','mod'=>'pssliderlayer'),$_smarty_tpl);?>
</option>
                                </select>
...
?>
        ...
        <input type="hidden" id="current_language" name="current_language" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['id_language']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"/>
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='col_width') {?>
        <div class="col-lg-9">
            <input type='hidden' class="col-val <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['class'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
' value='<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
'/>
            <button type="button" class="btn btn-default ptsbtn-width dropdown-toggle" tabindex="-1" data-toggle="dropdown">
                <span class="pts-width-val"><?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']],'-','.');?>
/12</span><span class="pts-width pts-w-<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"> </span><span class="caret"></span>
            </button>
            <ul class="dropdown-menu">
                <?php  $_smarty_tpl->tpl_vars['itemWidth'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['itemWidth']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['pts_width']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                <li>
                    <a class="pts-w-option" data-width="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['itemWidth']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" href="javascript:void(0);" tabindex="-1">                                          
                        <span class="pts-width-val"><?php echo mb_convert_encoding(htmlspecialchars(smarty_modifier_replace($_smarty_tpl->tpl_vars['itemWidth']->value,'-','.'), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
/12</span><span class="pts-width pts-w-<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['itemWidth']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"> </span>
                    </a>
                </li>
                <?php } ?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='group_class') {?>
        <div class="col-lg-9">
            <div class="well">
                <p> 
                    <input type="text" class="group-class" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" name="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"/><br />
                    <?php echo smartyTranslate(array('s'=>'insert new or select classes for toggling content across viewport breakpoints','mod'=>'pssliderlayer'),$_smarty_tpl);?>
<br />
...
?>
                        <li>
                            <input type="checkbox" name="col_<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['keyHidden']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
" value="1">
                            <label class="choise-class"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['itemHidden']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</label>
                        </li>
                        <?php } ?>
                    </ul>
                            ...
                            <div class="col-lg-6">
                                <div class="col-md-4">
                                    <a href="javascript:void(0)" class="btn btn-default btn-update-slider">
                                                <i class="icon-upload"></i> <?php echo smartyTranslate(array('s'=>'Select slider background','mod'=>'pssliderlayer'),$_smarty_tpl);?>
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                            <input type="color"
                                            data-hex="true"
                                            <?php if (isset($_smarty_tpl->tpl_vars['input']->value['class'])) {?>class="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['class'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '173915652e600d05ff0-26571624');
content_5652e60195f622_64418266($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2015-11-23 05:10:09
         compiled from "E:\Project\htdocs\pf_fshow_quickstart\admin123\themes\default\template\helpers\form\form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5652e60195f622_64418266')) {function content_5652e60195f622_64418266($_smarty_tpl) {?>
