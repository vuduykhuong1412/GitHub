<?php /* Smarty version Smarty-3.1.19, created on 2015-11-30 23:08:52
         compiled from "E:\Project\htdocs\pf_fshow_quickstart\themes\pf_fshow\password.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9144565d1d54c4f5a2-73100831%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f82aec77b5a30d886c93efec139ca07f1bbcd54d' => 
    array (
      0 => 'E:\\Project\\htdocs\\pf_fshow_quickstart\\themes\\pf_fshow\\password.tpl',
      1 => 1447227130,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9144565d1d54c4f5a2-73100831',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_565d1d54d45420_06994192',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_565d1d54d45420_06994192')) {function content_565d1d54d45420_06994192($_smarty_tpl) {?>
...
" method="post" class="std form-horizontal" id="form_forgotpassword">
			<fieldset>
				<div class="form-group">
					<label class="control-label col-xs-12 col-sm-4 col-md-4 col-lg-4" for="email"><?php echo smartyTranslate(array('s'=>'Email address'),$_smarty_tpl);?>
</label>
					<div class="control-label col-xs-12 col-sm-6 col-md-6 col-lg-6">
...
<?php }?>" />
				...
				<p class="submit col-xs-12 col-sm-offset-4 col-md-offset-4">
...
<i class="icon-chevron-right right"></i></span></button>
	...
	<?php }?>
	<ul class="clearfix footer_links list-unstyled">
		<li><a class="btn-default button btn" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication'), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Back to Login'),$_smarty_tpl);?>
" rel="nofollow"><span><i class="icon-chevron-left left"></i><?php echo smartyTranslate(array('s'=>'Back to Login'),$_smarty_tpl);?>
</span></a></li>
	</ul>
</div><?php }} ?>
