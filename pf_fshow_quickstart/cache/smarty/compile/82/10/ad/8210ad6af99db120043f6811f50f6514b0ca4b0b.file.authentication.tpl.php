<?php /* Smarty version Smarty-3.1.19, created on 2015-11-30 23:08:27
         compiled from "E:\Project\htdocs\pf_fshow_quickstart\themes\pf_fshow\authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2184565d1d3b4d14e5-68688379%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8210ad6af99db120043f6811f50f6514b0ca4b0b' => 
    array (
      0 => 'E:\\Project\\htdocs\\pf_fshow_quickstart\\themes\\pf_fshow\\authentication.tpl',
      1 => 1447226940,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2184565d1d3b4d14e5-68688379',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_565d1d3b964142_00958451',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_565d1d3b964142_00958451')) {function content_565d1d3b964142_00958451($_smarty_tpl) {?>
...
" method="post" id="new_account_form" class="std clearfix form-horizontal">
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					<h3 class="page-subheading bottom-indent"><?php echo smartyTranslate(array('s'=>'Instant checkout'),$_smarty_tpl);?>
</h3>
					<!-- Account -->
					<div class="required form-group">
						<label class="control-label col-sm-4" for="guest_email"><?php echo smartyTranslate(array('s'=>'Email address'),$_smarty_tpl);?>
 <sup>*</sup></label>
						<div class="col-sm-6">
...
<?php }?>" />
					...
					<div class="cleafix gender-line">
						<label class="control-label col-sm-4"><?php echo smartyTranslate(array('s'=>'Title'),$_smarty_tpl);?>
</label>
						<div class="col-sm-6">
...
<?php }?>" />
					...
					<div class="form-group date-select">
						<label class="control-label col-sm-4"><?php echo smartyTranslate(array('s'=>'Date of Birth'),$_smarty_tpl);?>
</label>
						<div class="col-sm-6">
							<div class="row">
...
&nbsp;&nbsp;</option>
					...
					<?php }?>
					<h3 class="page-subheading bottom-indent top-indent"><?php echo smartyTranslate(array('s'=>'Delivery address'),$_smarty_tpl);?>
</h3>
...
?>
						<?php if ($_smarty_tpl->tpl_vars['field_name']->value=="company") {?>
						<div class="form-group">
							<label class="control-label col-sm-4" for="company_invoice"><?php echo smartyTranslate(array('s'=>'Company'),$_smarty_tpl);?>
<?php if (in_array($_smarty_tpl->tpl_vars['field_name']->value,$_smarty_tpl->tpl_vars['required_fields']->value)) {?> <sup>*</sup><?php }?></label>
							<div class="col-sm-6">
...
<?php }?>" />
						...
						<div id="vat_number_block_invoice" style="display:none;">
							<div class="form-group">
								<label class="control-label col-sm-4" for="vat_number_invoice"><?php echo smartyTranslate(array('s'=>'VAT number'),$_smarty_tpl);?>
<?php if (in_array($_smarty_tpl->tpl_vars['field_name']->value,$_smarty_tpl->tpl_vars['required_fields']->value)) {?> <sup>*</sup><?php }?></label>
								<div class="col-sm-6">
...
<?php }?>" />
						...
						<div class="required form-group dni_invoice">
							<label class="control-label col-sm-4" for="dni_invoice"><?php echo smartyTranslate(array('s'=>'Identification number'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-6">
...
<?php }?>" />
						...
						<div class="required form-group">
							<label class="control-label col-sm-4" for="firstname_invoice"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-6">
...
<?php }?>" />
						...
						<div class="required form-group">
							<label class="control-label col-sm-4" for="lastname_invoice"><?php echo smartyTranslate(array('s'=>'Last name'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-6">
...
<?php }?>" />
						...
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="address1") {?>
						<div class="required form-group">
							<label class="control-label col-sm-4" for="address1_invoice"><?php echo smartyTranslate(array('s'=>'Address'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-6">
...
<?php }?>" />
						...
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="address2") {?>
						<div class="form-group is_customer_param">
							<label class="control-label col-sm-4" for="address2_invoice"><?php echo smartyTranslate(array('s'=>'Address (Line 2)'),$_smarty_tpl);?>
<?php if (in_array($_smarty_tpl->tpl_vars['field_name']->value,$_smarty_tpl->tpl_vars['required_fields']->value)) {?> <sup>*</sup><?php }?></label>
							<div class="col-sm-6">
...
<?php }?>" />
						...
						<div class="required postcode_invoice form-group">
							<label class="control-label col-sm-4" for="postcode_invoice"><?php echo smartyTranslate(array('s'=>'Zip / Postal Code'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-6">
				                		<input type="text" class="validate form-control" name="postcode_invoice" id="postcode_invoice" value="<?php if (isset($_POST['postcode_invoice'])&&$_POST['postcode_invoice']) {?><?php echo $_POST['postcode_invoice'];?>
<?php }?>" onkeyup="$('#postcode_invoice').val($('#postcode_invoice').val().toUpperCase());" />
							</div>
						</div>
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="city") {?>
						<div class="required form-group">
							<label class="control-label col-sm-4" for="city_invoice"><?php echo smartyTranslate(array('s'=>'City'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-6">
...
<?php }?>" />
						...
						<div class="required form-group">
							<label class="control-label col-sm-4" for="id_country_invoice"><?php echo smartyTranslate(array('s'=>'Country'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-6">
...
"<?php if ((isset($_POST['id_country_invoice'])&&$_POST['id_country_invoice']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_POST['id_country_invoice'])&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])) {?> selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
						...
						<div class="required id_state_invoice form-group" style="display:none;">
							<label class="control-label col-sm-4" for="id_state_invoice"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <sup>*</sup></label>
							<div class="col-sm-6">
...
<?php }?>" />
						...
						<?php }?>
						<div class="form-group is_customer_param">
							<label class="control-label col-sm-4" for="other_invoice"><?php echo smartyTranslate(array('s'=>'Additional information'),$_smarty_tpl);?>
</label>
							<div class="col-sm-6">
						...
						<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?>
							<div class="inline-infos required is_customer_param"><label class="col-sm-offset-4 col-sm-6"><?php echo smartyTranslate(array('s'=>'You must register at least one phone number.'),$_smarty_tpl);?>
</label></div>
						<?php }?>					
						<div class="form-group is_customer_param">
							<label class="control-label col-sm-4" for="phone_invoice"><?php echo smartyTranslate(array('s'=>'Home phone'),$_smarty_tpl);?>
</label>
							<div class="col-sm-6">
...
<?php }?>" />
						...
						<div class="<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?>required <?php }?>form-group">
							<label class="control-label col-sm-4" for="phone_mobile_invoice"><?php echo smartyTranslate(array('s'=>'Mobile phone'),$_smarty_tpl);?>
<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?> <sup>*</sup><?php }?></label>
							<div class="col-sm-6">
...
" />
			...
			<p class="cart_navigation required submit clearfix">
				...
				<button type="submit" class="button btn btn-default btn-warning button-medium pul-right" name="submitGuestAccount" id="submitGuestAccount">
					<span>
...
?>
	...
	<?php }?>-->
	<form action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true), ENT_QUOTES, 'UTF-8', true);?>
" method="post" id="account-creation_form" class="std box form-horizontal">
...
" <?php if (isset($_POST['id_gender'])&&$_POST['id_gender']==$_smarty_tpl->tpl_vars['gender']->value->id) {?>checked="checked"<?php }?> />
			...
			<div class="required form-group">
				<label class="control-label col-sm-4" for="customer_firstname"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
 <sup>*</sup></label>
				<div class="col-sm-6">
...
<?php }?>" />
			...
			<div class="required form-group">
				<label class="control-label col-sm-4" for="customer_lastname"><?php echo smartyTranslate(array('s'=>'Last name'),$_smarty_tpl);?>
 <sup>*</sup></label>
				<div class="col-sm-6">
...
<?php }?>" />
			...
			<div class="required password form-group">
				<label class="control-label col-sm-4" for="passwd"><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
 <sup>*</sup></label>
				<div class="col-sm-6">
...
<?php }?></textarea>
				...
				<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value) {?>
					<div class="inline-infos"><label class="col-sm-offset-4 col-sm-6"><?php echo smartyTranslate(array('s'=>'You must register at least one phone number.'),$_smarty_tpl);?>
</label></div>
				<?php }?>
				<div class="form-group">
...
<?php }?>" />
				...
				<div class="required form-group" id="address_alias">
					<label class="control-label col-sm-4" for="alias"><?php echo smartyTranslate(array('s'=>'Assign an address alias for future reference.'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="col-sm-6">
