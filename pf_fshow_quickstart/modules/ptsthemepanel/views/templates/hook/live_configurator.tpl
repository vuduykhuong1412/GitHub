					...
					<div class="form-group">
						<div class="pts-paneltitle"><b>{l s='RTL Mode' mod='ptsthemepanel'}</b>
							<select name="rtl_mode" id="pts-themelangrtl">
								<option value="0">{l s='No' mod='ptsthemepanel'}</option>
								<option value="1">{l s='Yes' mod='ptsthemepanel'}</option>
								
							</select>
						</div>
					</div>
					{if isset($headers) && $headers}
			 			<div class="pts-paneltitle"><b>{l s='Headers' mod='ptsthemepanel'}</b></div>
			 			<div class="form-group">
				 			<select name="headers">
									...
									<div class="theme-{$theme.skin|escape:'htmlall':'UTF-8'} btn-switchskin" data-theme="{$theme.skin|escape:'htmlall':'UTF-8'}">
										...
										<div class="clearfix">
											<label for="">{l s='Re-Hook, Config' mod='ptsthemepanel'}</label> 
											 {l s='Yes' mod='ptsthemepanel'}: <input type="radio" name="{$theme.skin|escape:'html':'UTF-8'}_rehook" value="1">
											 {l s='No' mod='ptsthemepanel'}: <input checked="checked" type="radio" name="{$theme.skin|escape:'html':'UTF-8'}_rehook" value="0"> 
										</div>
										{/if}
									</div>	
								{/foreach}
