...
<div class="hide"><div id="ptswarninginstall">
	...
	<div class="alert alert-danger" >
	 ...
	 <p>
	 	<a href="{$url|escape:'html':'UTF-8'}#sitetools" class="btn btn-lg btn-danger">{l s='Install Sample Now' mod='ptsthemepanel'}<br><em style="font-size:10px">{l s='Automatic Install Sample in Theme Control Panel' mod='ptsthemepanel'}</em></a> 
	 	<a href="{$url|escape:'html':'UTF-8'}" class="btn btn-lg btn-info">{l s='UserGuide' mod='ptsthemepanel'}<br><em style="font-size:10px">{l s='Manually Installing Sample Via Reading Guides' mod='ptsthemepanel'} </em></a> 
	 </p>
	 <p>
