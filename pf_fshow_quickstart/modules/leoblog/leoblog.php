...
//        $id_tab1 = $tab1->add(true, false);
	...
	{
		/* Adds Module */
		if (parent::install() && $this->registerHook('top') && $this->registerHook('displayNav') && $this->registerHook('leftColumn') && $this->registerHook('moduleRoutes') && $this->registerHook('displayBackOfficeHeader') && $this->registerHook('displayBanner'))
		{
			$res = true;

			Configuration::updateValue(_LEO_BLOG_PREFIX_.'CATEORY_MENU', 1);
			/* Creates tables */
...
//            $id_tab1 = $tab1->add(true, false);
	...
	public function getContent()
	{
		...
		{
			# validate module
			Configuration::updateValue(_LEO_BLOG_PREFIX_.'CATEORY_MENU', (int)Tools::getValue(_LEO_BLOG_PREFIX_.'CATEORY_MENU'));
		}
			...
			'form' => array(
				...
				'input' => array(
					array(
						...
						'name' => _LEO_BLOG_PREFIX_.'CATEORY_MENU',
	...
	{
		return array(
			_LEO_BLOG_PREFIX_.'CATEORY_MENU' => Tools::getValue(_LEO_BLOG_PREFIX_.'CATEORY_MENU', Configuration::get(_LEO_BLOG_PREFIX_.'CATEORY_MENU')),
		);
	}
	...
	public function hookLeftColumn()
	{
		...
		if (Configuration::get(_LEO_BLOG_PREFIX_.'CATEORY_MENU') && $this->_prepareHook())
