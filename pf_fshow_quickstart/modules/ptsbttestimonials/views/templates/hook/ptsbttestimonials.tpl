...
*}
<div id="ptsbttestimonials{$ptsbttestimonials_modid|escape:'htmlall':'UTF-8'}" class="carousel ptsbttestimonials" style="width: {$config_testimonials.test_width|escape:'htmlall':'UTF-8'}px; height: {$config_testimonials.test_height|escape:'htmlall':'UTF-8'}px;">
