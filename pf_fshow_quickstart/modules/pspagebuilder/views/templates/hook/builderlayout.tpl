...
{foreach from=$rows item=row name=row}
    ...
    {/if}    
    <div class="row row-level-{$row->level|escape:'html':'UTF-8'}"><div class="row-inner {if isset($row->sfxcls)&&$row->sfxcls}row-{$row->sfxcls|escape:'html':'UTF-8'} {/if} {if $row->level>=2}{$row->cls|escape:'html':'UTF-8'}{/if} clearfix" >
               ...
               {if isset($row->parallax)&&$row->parallax}
                ...
                {/if}
                    ...
                    {foreach $col->widgets as $widget}
                        ...
                        <div class="{$widget->wtype|escape:'html':'UTF-8'}">
